...
public class UIButtonSuper : Button, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private void PlayButtonSound(ButtonSoundType buttonSoundType)
    {
        ...
        if (!GameModule.Sound.HasSoundGroup(soundGroup))
        {
            GameModule.Sound.AddSoundGroup(soundGroup, 5);
        }
        ...
        {
            soundPath = $"Assets/GameMain/AssetsNative/Sound/{soundGroup}/{buttonSound.ButtonUISoundName}.mp3";
        }
        else
        {
            soundPath = $"Assets/GameMain/AssetsHotfix/Sound/{soundGroup}/{buttonSound.ButtonUISoundName}.mp3";
        }

        int audioId = GameModule.Sound.PlaySound(soundPath, soundGroup, 50, playSoundParams);
    }
